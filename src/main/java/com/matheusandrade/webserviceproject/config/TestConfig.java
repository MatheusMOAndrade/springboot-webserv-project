...
import com.matheusandrade.webserviceproject.entities.Payment;
import com.matheusandrade.webserviceproject.entities.Product;
import com.matheusandrade.webserviceproject.entities.User;
import com.matheusandrade.webserviceproject.entities.enums.OrderStatus;
import com.matheusandrade.webserviceproject.repositories.CategoryRepository;
import com.matheusandrade.webserviceproject.repositories.OrderItemRepository;
import com.matheusandrade.webserviceproject.repositories.OrderRepository;
import com.matheusandrade.webserviceproject.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Product p5 = new Product(null, "The Odyssey", "Cras fringilla convallis sem vel faucibus.", 100.99, "");

        categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));
        productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));

        // associete products with categories
        ...
        //save obj one to one, need update the old obj
        o1.setPayment(pay1);
